<!-- Generated by: generate_take_home({ unfinished_items: ["SA-1", "MC-4"] }) -->
# Take-Home: Finish Your Work
**Name:** Jasmine Bailey
**Lesson:** What is 'Community' and why is it important?
**Date:** __________ | **Due:** __________

---

**Note for Parent/Guardian:**

Jasmine Bailey is working on a reading comprehension lesson about what makes a community. Today in class, she read the article and answered some questions but didn't finish everything. This take-home packet includes:

- The parts of the article she needs to reference (so she doesn't need the full text)
- The questions she still needs to complete
...
*Jasmine Bailey's teacher can be reached at school for any questions.*

---

## Writing Question (SA-1)
...
### Sentence Starters (pick one to get started)
...
**You did good work in class today.** Finishing this at home shows that you can stick with hard work even when it takes extra time. That's a strength.