# Teacher Prep Summary: One Page Before Class
...
- [ ] **Graphic organizer** for paragraph 2/8: Two-column table (Trait of Community | How Lowe Tests It). Pre-fill left column with 6 traits.
